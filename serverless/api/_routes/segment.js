...
const { getAllSegments, getEpisodeSegments, postSegment, getNextSegment, deleteSegment } = require('../_controllers/segment')
...
router.get('/api/segment/episode/:id', setUser, verifyAdmin, getEpisodeSegments)
